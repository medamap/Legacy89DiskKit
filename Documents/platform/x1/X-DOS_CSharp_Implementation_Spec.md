...
The technical filesystem analysis is in `Documents/platform/x1/X-DOS_Filesystem_Analysis.md`.
The roadmap phases are in `Documents/governance/Roadmap_V2.md` under "X-DOS Filesystem Support".
