...
2. `Documents/governance/Roadmap_V2.md`
3. `Documents/governance/Cpp_Ddd_Folder_Migration_Rulebook.md`
...
The active migration plan is `Documents/governance/Roadmap_V2.md`.
...
- `Documents/governance/Cpp_Ddd_Folder_Migration_Rulebook.md`
...
6. update `Documents/governance/Roadmap_V2.md` when the phase is truly complete
7. update `Documents/governance/Cpp_Ddd_Folder_Migration_Rulebook.md` when file placement or relocation notes change
...
- Follow `AGENTS.md`, then read `Documents/governance/Agent_Handoff_Roadmap_V2.md`, then `Documents/governance/Roadmap_V2.md`, branch from `develop`, and continue with the next incomplete V2 phase.
