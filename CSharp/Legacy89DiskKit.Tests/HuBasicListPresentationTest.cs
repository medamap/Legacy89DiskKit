...
public class HuBasicListPresentationTest
{
    ...
    public void HuBasicFileListFormatter_FormatsFlagsAndAddresses()
    {
        ...
        var entry = new FileEntry(
            ...
            null,
            DateTime.UtcNow,
            new ExtendedFileAttributes(DomainFileAttributes.None, 0x71, false, "Hu-BASIC"),
            5,
            0x1200,
            0x121F,
            0x1300,
            null,
            null,
            new HuBasicFileMetadata(HuBasicFileType.Binary, true, true, true, true, false, 32, 0x1200, 0x1300, 5, 0x71, 0x41)
        );

        var view = formatter.Format(new FileListFormatContext(
            new DiskFileSystemInfo("Hu-BASIC", 320 * 1024, 64 * 1024, 4096, 32, "X1", "X1"),
            new[]
        {
    ...
    public void HuBasicFileListFormatter_DoesNotTreatSysExtensionAsSystemAttribute()
    {
        ...
        var entry = new FileEntry(
            ...
            null,
            DateTime.UtcNow,
            new ExtendedFileAttributes(DomainFileAttributes.None, 0x01, false, "Hu-BASIC"),
            8,
            0x2000,
            0x203F,
            0x2000,
            null,
            null,
            new HuBasicFileMetadata(HuBasicFileType.Binary, false, false, false, false, false, 64, 0x2000, 0x2000, 8, 0x01)
        );
        ...
        var view = formatter.Format(new FileListFormatContext(
            ...
            new[]
        {
            new FileListEntryContext(entry, "STARTUP.Sys", "STARTUP", "Sys", 64)
        }), Localizer);
    ...
    public void HuBasicFileListFormatter_PadsFullWidthNamesByDisplayWidth()
    {
        ...
        var entry = new FileEntry(
            ...
            null,
            DateTime.UtcNow,
            new ExtendedFileAttributes(DomainFileAttributes.None, 0x44, true, "Hu-BASIC"),
            34,
            0xF000,
            0xF300,
            0x0000,
            null,
            null,
            new HuBasicFileMetadata(HuBasicFileType.Ascii, false, false, false, true, false, 769, 0xF000, 0x0000, 34, 0x44)
        );
        ...
        var view = formatter.Format(new FileListFormatContext(
            ...
            new[]
        {
            new FileListEntryContext(entry, "音訓     変換.DIC", "音訓     変換", "DIC", 212)
        }), Localizer);
    ...
    {
        var formatter = new HuBasicFileListFormatter();
        var asciiEntry = new FileEntry(
            "README",
            "DOC",
            12288,
            null,
            DateTime.UtcNow,
            new ExtendedFileAttributes(DomainFileAttributes.None, 0x04, true, "Hu-BASIC"),
            11,
            0x0000,
            0x2FFF,
            0x0000,
            null,
            null,
            new HuBasicFileMetadata(HuBasicFileType.Ascii, false, false, false, false, false, 12288, 0x0000, 0x0000, 11, 0x04)
        );
        var basicEntry = new FileEntry(
            "HELLO",
            "BAS",
            135,
            null,
            DateTime.UtcNow,
            new ExtendedFileAttributes(DomainFileAttributes.None, 0x02, false, "Hu-BASIC"),
            42,
            0x0000,
            0x0086,
            0x0000,
            null,
            null,
            new HuBasicFileMetadata(HuBasicFileType.Basic, false, false, false, false, false, 135, 0x0000, 0x0000, 42, 0x02)
        );
        ...
        var view = formatter.Format(new FileListFormatContext(
            ...
            new[]
            {
                new FileListEntryContext(asciiEntry, "README.DOC", "README", "DOC", 12288),
    ...
    public void HuBasicFileListFormatter_AddsLabelEntryFootnote()
    {
        ...
        var entry = new FileEntry(
            ...
            null,
            DateTime.UtcNow,
            new ExtendedFileAttributes(DomainFileAttributes.ReadOnly, 0x44, true, "Hu-BASIC"),
            0x7FFF,
            0xFFFF,
            0xFFFF,
            0xFFFF,
            null,
            null,
            new HuBasicFileMetadata(HuBasicFileType.Ascii, true, false, false, true, false, 0, 0xFFFF, 0xFFFF, 0x7FFF, 0x44, 0x01)
        );
    ...
    public void HuBasicFileListFormatter_AddsBootSummary()
    {
        ...
        var view = formatter.Format(new FileListFormatContext(
            ...
            null,
            new BootInfoSummary(BootInfoMode.FileBacked, "STARTUP.Sys", 0x2000, 0x2000)), Localizer);
