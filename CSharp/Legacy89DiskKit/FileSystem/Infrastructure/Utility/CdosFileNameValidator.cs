...
/// <summary>
/// Validates CDOS file names (8.3 format)
/// </summary>
public static class CdosFileNameValidator
{
    private const int MaxFileNameLength = 8;
    private const int MaxExtensionLength = 3;
    
    /// <summary>
    /// Characters that are not allowed in CDOS filenames
    /// </summary>
    private static readonly char[] InvalidChars = { '<', '>', '.', ',', ';', ':', '=', '?', '*', '[', ']', '%', '|', '(', ')', '/', '\\', '"', '+' };

    /// <summary>
    /// Validates a CDOS filename
    /// </summary>
    ...
    /// <summary>
    /// Normalizes a filename to CDOS format (uppercase, 8.3 format)
    /// </summary>
    ...
    /// <summary>
    /// Formats a filename for CDOS directory entry (space padded)
    /// </summary>
    ...
    /// <summary>
    /// Converts a CDOS wildcard pattern to regex pattern
    /// </summary>
