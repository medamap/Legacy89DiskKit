    ...
    private static readonly Dictionary<char, byte> WinToX1Map = new Dictionary<char, byte>
{
    ...
    public static string X1ToWin(byte[] x1Data)
    {
        var result = new StringBuilder();
        foreach (var b in x1Data)
        {
            result.Append(X1ToWinMap.TryGetValue(b, out var ch) ? ch : '□');
        }
        return result.ToString();
    }

    public static byte[] WinToX1(string winText)
    {
    ...
    public static string ConvertLineEndings(string input, bool toWindows)
    {
        if (toWindows)
        {
            return input
