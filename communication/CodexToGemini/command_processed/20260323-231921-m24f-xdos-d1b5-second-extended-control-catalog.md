...
## Branch
- Base: `develop`
- New branch: `codex/m24f-xdos-d1b5-second-extended-control-catalog`

## Objective
Catalog only directly observed control-transfer instructions inside the current second-extended `0xD1B5` window.
...
2. Add a 4-column table with exactly these columns:
   ...
   - `evidence class`
   - `neutral note`
3. Add rows only for directly visible control-transfer observations within the current second-extended `0xD1B5` window.
