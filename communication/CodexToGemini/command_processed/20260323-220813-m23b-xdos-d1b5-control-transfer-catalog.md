...
## Branch
- Base: `develop`
- New branch: `codex/m23b-xdos-d1b5-control-transfer-catalog`

## Objective
Catalog only directly observed control-transfer instructions inside the already-cataloged `0xD1B5` target window.
...
2. Add a 4-column table with exactly these columns:
   ...
   - `evidence class`
   - `neutral note`
3. Add rows only for directly visible control-transfer observations within the existing `0xD1B5` window.
