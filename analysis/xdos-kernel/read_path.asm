...
; Target window cataloged from helper_d6af sub-call
    db 0x04, 0x42, 0x0E, 0x00, 0xC9 ; literal: 0x00
...
; Target window cataloged from helper_d6af final jump
    db 0x40, 0x20, 0x0D, 0x13, 0xCD, 0xB5, 0xD1, 0x3E, 0x01 ; literals: 0x0D, 0xD1B5, 0x01

org 0xDEE8
; Target window cataloged from helper_d6af sub-call after 1D/1E load
    db 0x01, 0x40, 0x01, 0x11, 0xA8, 0x00, 0x21, 0x00, 0xEE, 0x19 ; literals: 0x0140, 0x00A8, 0xEE00

org 0xE00E
; Target window cataloged from helper_d6af sub-call
    db 0xEB, 0xDF, 0x38, 0x72, 0x06 ; literal: 0x72
