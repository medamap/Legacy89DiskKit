...
; Target window cataloged from 0xD3F7 call
    db 0x19, 0x7E, 0xE1, 0xD1, 0xCD, 0xC5, 0xDA, 0xD8, 0x3A, 0x11, 0xED, 0xF5, 0xCD, 0x55, 0xD1, 0xF1 ; confirmed: 0xD8DA target window; literal: 0xDAC5, 0xED11, 0xD155

org 0xDAB2
; Target window cataloged from 0xD470 call
    db 0x42, 0xC1, 0x3E, 0x09, 0xD8, 0xCD, 0x45, 0xDF, 0x7A, 0x32, 0xED, 0xEC, 0x7B, 0x32, 0xEE, 0xEC ; confirmed: 0xDAB2 target window; literal: 0x09, 0xDF45, 0xECED, 0xECEE
