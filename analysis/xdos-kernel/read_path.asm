...
; Target window cataloged from 0xD753 call
    db 0x01, 0x28, 0x03, 0x01, 0x22, 0x05, 0xC5, 0x21, 0xD0, 0xEC, 0x11, 0xB0, 0xEC, 0x01, 0x20, 0x00, 0xED, 0xB0, 0xC1, 0x3A, 0x11, 0xED, 0xF5, 0x3A, 0x1F, 0xED, 0x32, 0x11, 0xED, 0x32, 0x5E, 0xE7 ; confirmed: 0xD1B5 target window; literal: 0x0328, 0x0522; transfer: none
