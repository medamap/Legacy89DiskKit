...
; Called by: helper_c9bc (0xC9BC)
; Purpose: [Unknown]
    db 0xFA, 0x93, 0xF8 ; literal: 0xF893; transfer: jp m, 0xF893
    db 0x3C             ; inc a
    db 0x47             ; ld b, a
    db 0x36, 0x00       ; ld (hl), 0
    db 0x23             ; inc hl
    db 0x10, 0xFB       ; transfer: djnz -5 (targets ld (hl), 0)
    db 0x3A, 0xE4, 0xFA ; literal: 0xFAE4
    db 0x67             ; ld h, a
    db 0x3A, 0xE6, 0xFA ; literal: 0xFAE6
    db 0x6F             ; ld l, a
    db 0xE5             ; push hl
    db 0x2A, 0xDF, 0xFA ; literal: 0xFADF
    db 0xED, 0x5B, 0xD0, 0xF8 ; literal: 0xF8D0
    db 0xCB, 0xF3       ; set 6, e
    db 0xCD, 0x38, 0xEA ; literal: 0xEA38; transfer: call 0xEA38
    db 0xC1             ; pop bc

org 0xEA38
; EA38 Target Byte Window (Analysis-Only)
; Called by: 0xEB32
; Purpose: [Unknown]
    db 0x25             ; dec h
    db 0xED, 0x5B, 0xD0, 0xF8 ; ld de, (0xF8D0)
    db 0xCB, 0xF3       ; set 6, e
    db 0xC3, 0x38, 0xEA ; transfer: jp 0xEA38 (self-loop)
...
; Target window cataloged from 0xD1B5 call
    db 0xED, 0xCD, 0xCD, 0xDA, 0xD8, 0x3A, 0x2C, 0xE7, 0xB7, 0xC2, 0x2C, 0xD2, 0x32, 0x04, 0xED, 0x3A ; confirmed: 0xD3F7 target window; literal: 0xD8DA, 0xE72C, 0xD22C, 0xED04; transfer: call 0xD8DA, jp nz 0xD22C

org 0xD470
; Target window cataloged from 0xD1B5 call
    db 0x22, 0xE7, 0xCD, 0xA9, 0xDD, 0xBF, 0xC9, 0xCD, 0xB2, 0xDA, 0xC3, 0xBE, 0xDA, 0x2A, 0x27, 0xE7 ; confirmed: 0xD470 target window; literal: 0xCDE7, 0xDAB2, 0xDABE, 0xE727; transfer: ret, call 0xDAB2, jp 0xDABE

org 0xD8DA
; Target window cataloged from 0xD3F7 call
    db 0x19, 0x7E, 0xE1, 0xD1, 0xCD, 0xC5, 0xDA, 0xD8, 0x3A, 0x11, 0xED, 0xF5, 0xCD, 0x55, 0xD1, 0xF1 ; confirmed: 0xD8DA target window; literal: 0xDAC5, 0xED11, 0xD155; transfer: call 0xDAC5, ret c, call 0xD155

org 0xDAB2
; Target window cataloged from 0xD470 call
    db 0x42, 0xC1, 0x3E, 0x09, 0xD8, 0xCD, 0x45, 0xDF, 0x7A, 0x32, 0xED, 0xEC, 0x7B, 0x32, 0xEE, 0xEC ; confirmed: 0xDAB2 target window; literal: 0x09, 0xDF45, 0xECED, 0xECEE; transfer: ret c, call 0xDF45
