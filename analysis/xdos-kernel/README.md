...
-   `read_path.asm`: Assembly reconstruction of confirmed read-related kernel areas. The 0xD1B5 target window is now cataloged. 0xD1B5 slice boundary notes now exist. Extended 0xD1B5 slice boundary notes now exist. Second-extended 0xD1B5 slice boundary notes now exist. The 0xD3F7 slice boundary is now annotated. The 0xD470 slice boundary is now annotated. Second-hop slice boundary notes for 0xD8DA and 0xDAB2 now exist. The 0xC9EA slice boundary is now annotated. The 0xCABA slice boundary is now annotated.
