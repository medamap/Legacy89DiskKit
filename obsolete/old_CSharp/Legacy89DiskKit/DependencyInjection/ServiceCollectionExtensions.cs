...
using Legacy89DiskKit.DiskOperation.Application;
...
public static class ServiceCollectionExtensions
{
    public static IServiceCollection AddLegacy89DiskKit(this IServiceCollection services)
    {
        ...
        // Disk operation services
        services.AddSingleton<IFileNameConverter, FileNameConverter>();
        services.AddTransient<IFileCopyService, FileCopyService>();
