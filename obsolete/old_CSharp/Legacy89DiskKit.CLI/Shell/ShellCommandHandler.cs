...
public class ShellCommandHandler
{
    ...
    public ShellCommandHandler(SlotManager slotManager, CharacterEncodingService characterEncodingService, IDiskContainerFactory diskContainerFactory, IFileCopyService fileCopyService = null!)
    {
